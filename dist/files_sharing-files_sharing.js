...
/* harmony export */   getFileActions: function() { return /* binding */ getFileActions; },
/* harmony export */   registerFileAction: function() { return /* binding */ registerFileAction; }
/* harmony export */ });
...
var registerFileAction = function registerFileAction(action) {
  if (typeof window._nc_fileactions === 'undefined') {
    window._nc_fileactions = [];
    _logger__WEBPACK_IMPORTED_MODULE_0__["default"].debug('FileActions initialized');
  }
  // Check duplicates
  if (window._nc_fileactions.find(function (search) {
...
var getFileActions = function getFileActions() {
...
var action = new _files_src_services_FileAction__WEBPACK_IMPORTED_MODULE_5__.FileAction({
  id: 'accept-share',
  displayName: function displayName(nodes) {
    return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translatePlural)('files_sharing', 'Accept share', 'Accept shares', nodes.length);
  },
  iconSvgInline: function iconSvgInline() {
    return _mdi_svg_svg_check_svg_raw__WEBPACK_IMPORTED_MODULE_4__;
  },
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_3__["default"].post(url);
          case 5:
...
var action = new _files_src_services_FileAction__WEBPACK_IMPORTED_MODULE_1__.FileAction({
  id: 'open-in-files',
  displayName: function displayName() {
    return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.translate)('files', 'Open in Files');
  },
  iconSvgInline: function iconSvgInline() {
    return '';
  },
...
var action = new _files_src_services_FileAction__WEBPACK_IMPORTED_MODULE_5__.FileAction({
  id: 'reject-share',
  displayName: function displayName(nodes) {
    return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translatePlural)('files_sharing', 'Reject share', 'Reject shares', nodes.length);
  },
  iconSvgInline: function iconSvgInline() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_3__["default"].delete(url);
          case 5:
            // Remove from current view
            (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_0__.emit)('files:node:deleted', node);
            return _context.abrupt("return", true);
...
var action = new _files_src_services_FileAction__WEBPACK_IMPORTED_MODULE_5__.FileAction({
  id: 'restore-share',
  displayName: function displayName(nodes) {
    return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translatePlural)('files_sharing', 'Restore share', 'Restore shares', nodes.length);
  },
  iconSvgInline: function iconSvgInline() {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateOcsUrl)('apps/files_sharing/api/v1/deletedshares/{id}', {
              id: node.attributes.id
            });
            _context.next = 4;
            return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_3__["default"].post(url);
...
/******/ })()
;
//# sourceMappingURL=files_sharing-files_sharing.js.map?v=fdc1d843747de5d2eb0d